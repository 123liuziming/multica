...
func TestParsePullRequestURL_Rejects(t *testing.T) {
	bad := []string{
		...
		"http://127.0.0.1/foo",
		"http://10.0.0.1/foo",
		"https://github.com/cli/cli/pull/1",       // GitHub PRs are linked via webhook only — manual linking unsupported.
		"https://github.com/cli/cli/pull/8888",
		"https://www.github.com/cli/cli/pull/1",
		"https://github.com/cli/cli/issues/1",
		"https://gitlab.com/foo/bar/-/merge_requests/1",
		"https://bitbucket.org/foo/bar/pull-requests/1",
		"https://code.alibaba-inc.com/owner/repo", // Aone needs /codereview/<n> too.
	}
	for _, raw := range bad {
